...
import { BallObject, BallProps, PaddleLeft, PaddleRight, PongGame, Score, ScoreProps } from "./PongGame";
...
function App() {
  ...
  const ballEntityQuery = useEntityQuery([HasValue(Ball, {game_id: BigInt(42)})], {updateOnValueChange: true})
  const bat1EntityQuery = useEntityQuery([HasValue(Bat, {game_id: BigInt(42), player_id: BigInt(1)})], {updateOnValueChange: true})
  const bat2EntityQuery = useEntityQuery([HasValue(Bat, {game_id: BigInt(42), player_id: BigInt(2)})], {updateOnValueChange: true})
  ...
  return (
    <>
      ...
      <div className="card">
        <button onClick={() => spawn(account.account, 42)}>Spawn</button>
      ...
      <Stage width={600} height={400}>
        ...
        <Layer>
          ...
          <PaddleLeft yPos={bat1?.y_index || 300} />
          <PaddleRight yPos={bat2?.y_index || 300} />
          <BallObject xPos={BallPosition.xPos} yPos={BallPosition.yPos} />
